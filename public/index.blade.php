@@include('header.htm')
@@include('blocks/head.htm', {"home":"active" })
        ...
        <div class="row text-center">
            <div class="col-lg-8 mx-auto">
                ...
                <p class="mb-5">Lorem ipsum dolor sit amet, consecttur adipiscing Orci
                    fauff cibus urna, sed senectus iaculis leo condimentum. Maenas nec adipiscing neque, pellentesque
                    in. Metus
                    fusce.</p>
        ...
        <div class="row  justify-content-center align-items-center">
            ...
            <div class=" col-md-6" data-aos="fade-left" data-aos-duration="1500">
                <p class="mb-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Males
                    a est sagittis et nulla leo ut nulla aliquam. Nisi, fermentum venentis enim vel suspend wergisse eu
                    magnis
                    libero orci. Malesuada tortor aliquam malesuada vitae, ullamcorper nisl eget gravda et. Vivmus arcu
                    laoreet
            ...
            <div class="col-lg-5">
                <div class="section-title mb-5">
                    <h2>I Have brunch Of Huge <strong>
                            Experience.....
                            <svg width="243" height="19" viewBox="0 0 243 19" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
            ...
            <div class="col-lg-6 col-12 mx-auto ">
                <div class="section-title mb-md-5">
                    <h2>Our <strong>Testimonial
                            <svg width="288" height="20" viewBox="0 0 288 20" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                        ...
                        <div class="ms-lg-5 ms-md-4  mb-3">
                            <div class="ms-md-4">
                                <p>Lorem ipsum dolor sit amet, conse ctetur addipis cing elit. Malesa est sagittis
                                    et nulla leo ut nulsla aliquam. Nisi, fermentum venentis enim vel sussp end wergisse
                                    eu magnis
                                    libero
                                    orci. Males uasda eget gravda et. Vivmus arcu laoreet gravida purus cras. Et laoreet
                                    sit feugiat
