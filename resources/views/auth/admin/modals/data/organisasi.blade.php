            ...
            <form id="M_F_organisasi" action="{{ url('/' . request()->segment(1) . '/' . request()->segment(2) . '/' . request()->segment(3) . '/update') }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="divider mt-4 mb-0">
                        <div class="divider-text">Setting Akun</div>
                    </div>
                    <div class="mb-3">
                        <label class="form-label" for="U_username">Username</label>
                        <input type="text" class="form-control" id="U_username" name="name" placeholder="..." />
                    </div>
                    <div class="mb-3">
                        <label class="form-label" for="U_password">Password</label>
                        <input type="password" class="form-control" id="U_password" name="password" placeholder="..." />
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal">
...
<div class="modal modalView fade" id="M_V_organisasi" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog" role="document" style="min-width: 95%">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">
                    Organisasi <span class="badge bg-primary text-white">Detail</span>
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
