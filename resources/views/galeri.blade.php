       ...
       <div class="container">
           ...
           <div class="row g-4 g-md-5 ">
               ...
               @foreach ($galeris as $galeri)
                   <div class="col-md-6 image-item">
                       <div class="card rounded-0 border-0" data-aos="fade-up" data-aos-duration="1500">
                           <img class="img-fluid card-img-top" src="{{ asset('storage/' . $galeri->gambar) }}" alt="img">
                           {{-- <div class="card-img-overlay"> --}}
                           {{-- <div class="card-body"> --}}
                           <div class="card-text">
                               {{-- <a href="{{ route('post-prestasi', $galeri->id) }}" class="h4 text-dark"> {{ $galeri->deskripsi }}</a> --}}
                               {{-- <a href="{{ route('post-prestasi', $galeri->id) }}" class="h4 text-dark postPrestasiModal me-3" data-id="{{ $galeri->id }}">
                                   {{ $galeri->deskripsi }}
                               </a> --}}

                               <button type="button" class="btn btn-link text-dark postGaleriModal ps-0 me-3" data-id="{{ $galeri->id }}">
                                   <div class="h4">{{ $galeri->deskripsi }}</div>
                               </button>
               ...
               <div class="col-12 mx-auto text-center">
                   <a href="{{ route('galeries') }}" class="btn btn-outline-primary text-capitailize fw-medium py-2">view
                       all</a>
               </div>
           </div>
       </div>
   ...
   @include('guest.modals.modal_galeri')
