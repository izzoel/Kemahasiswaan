...
class MahasiswaImport implements ToModel, WithHeadingRow
{
    ...
    public function model(array $row)
    {
        ...
        $gelar = match ($prodi) {
            'DIPLOMA TIGA FARMASI', 'D3 FARMASI' => 'Ahli Madya Farmasi (A.Md.Farm.)',
            'DIPLOMA TIGA ANALIS KESEHATAN', 'D3 ANALIS KESEHATAN' => 'Ahli Madya Analis Kesehatan (A.Md.A.K.)',
            'SARJANA FARMASI', 'S1 FARMASI' => 'Sarjana Farmasi (S.Farm.)',
            'SARJANA ADMINISTRASI RUMAH SAKIT', 'S1 ADMINISTRASI RUMAH SAKIT' => 'Sarjana Kesehatan (S.Kes.)',
            'SARJANA GIZI', 'S1 GIZI' => 'Sarjana Gizi (S.Gz.)',
            'SARJANA HUKUM', 'S1 HUKUM' => 'Sarjana Hukum (S.H.)',
            'SARJANA MANAJEMEN', 'S1 MANAJEMEN' => 'Sarjana Manajemen (S.M.)',
            'SARJANA PENDIDIKAN GURU SEKOLAH DASAR', 'S1 PENDIDIKAN GURU SEKOLAH DASAR' => 'Sarjana Pendidikan (S.Pd.)',
            default => throw new \Exception("Data pada template salah"),
        };
        ...
        if ($mahasiswa) {
            ...
            try {
                ...
                Log::info('Berhasil insert data mahasiswa dengan NIM ' . $row['nim']);
            } catch (\Exception $e) {
