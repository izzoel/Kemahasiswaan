...
INSERT INTO `danas` (`id`, `id_ormawa`, `tanggal_kegiatan`, `id_kegiatan`, `dana`, `berkas`, `status`, `id_status`, `created_at`, `updated_at`) VALUES
	(1, '1', '01 Juni, 05:00 sore - 03 Juni, 01:00 pagi', 1, 'Rp 1.000.000', 'dana/Lampiran penutupan 11103148901_2.pdf', 'Disetujui', '2', '2024-06-01 09:57:13', '2024-06-01 09:58:44');
...
-- Dumping data for table kms.kegiatans: ~2 rows (approximately)
...
INSERT INTO `kegiatans` (`id`, `id_ormawa`, `tanggal`, `nama`, `anggaran`, `berkas`, `status`, `id_status`, `created_at`, `updated_at`) VALUES
	(1, 1, '01 Juni, 05:00 sore - 03 Juni, 01:00 pagi', 'Kegiatan 1', 'Rp 120.000', 'kegiatan/Invoice-226122.pdf', 'Ditinjau', '1', '2024-06-01 09:57:00', '2024-06-01 09:57:00'),
	(2, 1, '01 Juni, 05:00 sore - 03 Juni, 01:00 pagi', 'Kegiatan 2', 'Rp 120.000', 'kegiatan/Invoice-226122.pdf', 'Ditolak', '3', '2024-06-01 09:59:50', '2024-06-01 10:01:42');
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES
	...
	(77, '2024_06_01_092240_create_transaksi_statuses_table', 6);
...
CREATE TABLE IF NOT EXISTS `transaksi_statuses` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `pengajuan` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Dumping data for table kms.transaksi_statuses: ~3 rows (approximately)
DELETE FROM `transaksi_statuses`;
/*!40000 ALTER TABLE `transaksi_statuses` DISABLE KEYS */;
INSERT INTO `transaksi_statuses` (`id`, `pengajuan`, `id_transaksi`, `status`, `keterangan`, `created_at`, `updated_at`) VALUES
	(1, 'Kegiatan', 1, 'Ditinjau', 'Sedang ditinjau Rektor', '2024-06-01 09:57:00', '2024-06-01 09:57:40'),
	(2, 'Dana', 1, 'Disetujui', 'ACC', '2024-06-01 09:57:14', '2024-06-01 09:58:44'),
	(3, 'Kegiatan', 2, 'Ditolak', 'perbaiki', '2024-06-01 09:59:50', '2024-06-01 10:00:29');
